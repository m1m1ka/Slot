...
namespace Core
{
    ...
    public static class ScratchPatternDefaultProvider
    {
        private static readonly List<ScratchPatternConfig> Patterns = new List<ScratchPatternConfig>
        {
            ...
            new ScratchPatternConfig { Id = 8, Name = "钻石", BaseScore = 100, AtlasPath = "Icons/Patterns", SpriteName = "Diamond" },
            new ScratchPatternConfig { Id = 9, Name = "皇冠", BaseScore = 150, AtlasPath = "Icons/Patterns", SpriteName = "Crown" },
            new ScratchPatternConfig { Id = 10, Name = "幸运7", BaseScore = 250, AtlasPath = "Icons/Patterns", SpriteName = "Seven" },
            new ScratchPatternConfig { Id = 11, Name = "倍率图案", BaseScore = 0, AtlasPath = "Icons/Patterns", SpriteName = "Multiplier", EffectType = ScratchPatternEffectType.AddRewardMultiplierOnRevealed, EffectValue = 0.5d },
