...
namespace Core
{
    public static class LevelDefaultsProvider
    {
        ...
        {
            { 1, new LevelConfig { Id = 1, Name = "第1关", RequiredCoins = 800, ScratchCardPurchaseLimit = 5 } },
            { 2, new LevelConfig { Id = 2, Name = "第2关", RequiredCoins = 1800, ScratchCardPurchaseLimit = 6 } },
            { 3, new LevelConfig { Id = 3, Name = "第3关", RequiredCoins = 3000, ScratchCardPurchaseLimit = 7 } },
            { 4, new LevelConfig { Id = 4, Name = "第4关", RequiredCoins = 5000, ScratchCardPurchaseLimit = 7 } },
            { 5, new LevelConfig { Id = 5, Name = "第5关", RequiredCoins = 8000, ScratchCardPurchaseLimit = 8 } },
            { 6, new LevelConfig { Id = 6, Name = "第6关", RequiredCoins = 10000, ScratchCardPurchaseLimit = 8 } },
            { 7, new LevelConfig { Id = 7, Name = "第7关", RequiredCoins = 15000, ScratchCardPurchaseLimit = 9 } },
            { 8, new LevelConfig { Id = 8, Name = "第8关", RequiredCoins = 25000, ScratchCardPurchaseLimit = 9 } },
            { 9, new LevelConfig { Id = 9, Name = "第9关", RequiredCoins = 40000, ScratchCardPurchaseLimit = 10 } },
            { 10, new LevelConfig { Id = 10, Name = "第10关", RequiredCoins = 80000, ScratchCardPurchaseLimit = 10 } },
            { 11, new LevelConfig { Id = 11, Name = "第11关", RequiredCoins = 120000, ScratchCardPurchaseLimit = 11 } },
            { 12, new LevelConfig { Id = 12, Name = "第12关", RequiredCoins = 180000, ScratchCardPurchaseLimit = 11 } },
            { 13, new LevelConfig { Id = 13, Name = "第13关", RequiredCoins = 250000, ScratchCardPurchaseLimit = 12 } },
            { 14, new LevelConfig { Id = 14, Name = "第14关", RequiredCoins = 400000, ScratchCardPurchaseLimit = 12 } },
            { 15, new LevelConfig { Id = 15, Name = "第15关", RequiredCoins = 600000, ScratchCardPurchaseLimit = 13 } }
        };
